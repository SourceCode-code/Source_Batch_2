...
console.log("Qes no.4.(1) Ans is :",Math.ceil(num));
//math ceil= 6
...
console.log("Qes no.6 Ans is : Number in between 1 to 12 ",Math.floor(randomVal *10));
...
console.log("Qes no.9 Ans is :",Math.round(number1*100)/100)
