...
let str11 = "API";
console.log("Includes 'API':", str11.includes("API"));

// 12. Extract the last 4 characters from the string "automation testing".

let str12 = "automation testing";
console.log(str12.substr(14,15));

// 13. Convert the string "HELLOworld" to lowercase and remove spaces from the beginning and en
let str13="HELLO WORLD";
let h1= str13.toLowerCase().trim();
console.log(h1);
...
let h2= str14.replace("test", "exam");
console.log(h2);
//thanks 