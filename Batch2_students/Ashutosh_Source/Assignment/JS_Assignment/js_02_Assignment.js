...
/*The output for above code will be between 0 to 15,
...
between 0 to 15.99, and we have applied the floor function so it will convert the lowest possible value.*/

// //7 generate  randomBetween(10, 20) should generate a number between 10 and 20.
randomBetween = Math.random() * 10 + 10
console.log(Math.floor(randomBetween));
