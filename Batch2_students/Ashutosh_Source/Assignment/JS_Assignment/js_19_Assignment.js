...
let strstudent = JSON.stringify(student["firstName","lastName","skills"])
...
let maximunSkil={}
let maxSkills = 0
for (let i in JSONtxt){
    if((JSONtxt[i]['skills'].length)>maxSkills){
        maximunSkil=JSONtxt[i]
    }
}
console.log(maximunSkil)