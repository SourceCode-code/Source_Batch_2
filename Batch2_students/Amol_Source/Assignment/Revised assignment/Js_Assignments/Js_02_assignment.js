...
// let roll1st = Math.ceil(Math.random()*6)
// let roll2nd = Math.ceil(Math.random()*6)
// console.log(roll1st,roll2nd)


// 6. What will be the result of the following code? Explain why.
// let randomVal = Math.random();
// console.log(Math.floor(randomVal * 10) + 5); //output 5 to 14 floor always start/end with base value
