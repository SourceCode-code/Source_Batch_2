...
// function tenMostFrequentWords(paragraph, words) {
...
//------------Not sure about the logic about the above question ; NEED HELP for this !!-------------------- \\
...
//  ```
let sentence = entence = `%I $am@% a %tea@cher%, &and& I lo%#ve %tea@ching%;. There $is nothing; &as& mo@re rewarding as educa@ting &and& @emp%o@wering peo@ple. ;
