...
//Question asked to siddhant in his interview recently\\
let str = "ishita ingale";
let repeated = 1 ;
function MostcountLetters(str) {
...
let sorted = MostcountLetters("ishita ingale")
console.log(sorted)
