...
letting the user agent start preloading resources while the server prepares a response or preconnect 
...
a representation of the result of one or 
...
user agent must not change the HTTP method used: if a POST was used in the first request,
a POST must be used in the second request.


// 4 : ---------------------------------------CLIENT ERROR REsonses--------------------\\
